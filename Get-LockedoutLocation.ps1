...
.NOTE
This function is only compatible with an environment where the domain controller with the PDCe role
...
function Get-LockedLocation($Identity){
    Begin
    { 
        $DCCounter = 0 
        $LockedOutStats = @()   
